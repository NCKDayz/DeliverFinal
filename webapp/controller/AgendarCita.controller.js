sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.manageProducts.controller.AgendarCita", {
		...
		_onSearchFieldSearch: function(oEvent) {
			var sControlId = "Fiori_ObjectPage_ObjectPage_0-sections-Fiori_ObjectPage_Section-1716190133331-sectionContent-sap_m_VBox-1716410313567-items-sap_m_ObjectList-1716410355156";
			...
			return new Promise(function(fnResolve) {
				...
				if (sQuery && sQuery.length > 0) {
					...
					aFilters.push(new sap.ui.model.Filter("Empresa", sap.ui.model.FilterOperator.Contains, sQuery));

					aFilters.push(new sap.ui.model.Filter("Rol", sap.ui.model.FilterOperator.Contains, sQuery));

					aFilters.push(new sap.ui.model.Filter("Direccion", sap.ui.model.FilterOperator.Contains, sQuery));

					aFilters.push(new sap.ui.model.Filter("Telefono", sap.ui.model.FilterOperator.Contains, sQuery));
					...
					aFilters.push(new sap.ui.model.Filter("Asesor", sap.ui.model.FilterOperator.Contains, sQuery));

					aFilters.push(new sap.ui.model.Filter("Ciudad", sap.ui.model.FilterOperator.Contains, sQuery));

					aFilters.push(new sap.ui.model.Filter("Comentarios", sap.ui.model.FilterOperator.Contains, sQuery));
			...
			return new Promise(function(fnResolve) {
				...
				.then(function(result) {
					if (result === false) {
						...
						return new Promise(function(fnResolve) {
							sap.m.MessageBox.confirm("Cita agendada con éxito", {
								title: "Cita Agendada",
								actions: ["OK", ""],
		...
		onInit: function() {
			...
			this.oRouter.getTarget("AgendarCita").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "Fiori_ObjectPage_ObjectPage_0-sections-Fiori_ObjectPage_Section-1716190133331-sectionContent-sap_m_VBox-1716410313567-items-sap_m_ObjectList-1716410355156",
				"groups": ["items"]
			}];
