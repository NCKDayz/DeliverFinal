sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.manageProducts.controller.ListaProspectos", {
		...
		_onFioriListReportTableItemPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				this.doNavigate("DetalleProspecto", oBindingContext, fnResolve, "");
		...
		_onFioriListReportActionButtonPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("CrearProspecto", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		_onFioriListReportActionButtonPress1: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("AgendarCita", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		_onFioriListReportActionButtonPress2: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("ListaCitas", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		onInit: function() {
			...
			this.oRouter.getTarget("ListaProspectos").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
