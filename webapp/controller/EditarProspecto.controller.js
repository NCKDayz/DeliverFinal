sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.manageProducts.controller.EditarProspecto", {
			...
			return new Promise(function(fnResolve) {
				...
				.then(function(result) {
					if (result === false) {
						...
						alert("Prospecto Editado con exito");
				...
				.then(function(result) {
					if (result === false) {
						...
						return new Promise(function(fnResolve) {
							...
							this.doNavigate("ListaProspectos", oBindingContext, fnResolve, "");
						}.bind(this));
		...
		onInit: function() {
			...
			this.oRouter.getTarget("EditarProspecto").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
